                ...
                (this.remove = function(a, b, c) {
                  for (var d = 0, e = 0, f = r.items.length; e < f; e++)
                    r.items[e].values()[a] == b &&
                      (r.templater.remove(r.items[e], c), r.items.splice(e, 1), f--, e--, d++)
                  return r.update(), d
                }),
    ...
    5: [
      function(a, b, c) {
        b.exports = function(b) {
          var c = a("./item")(b),
            d = function(a) {
              for (var b = a.childNodes, c = [], d = 0, e = b.length; d < e; d++)
          ...
          var b,
            ...
            f = {
              ...
              setColumns: function() {
                0 !== a.items.length &&
                  void 0 === c &&
                  (c =
                    void 0 === a.searchColumns ? f.toArray(a.items[0].values()) : a.searchColumns)
              },
            ...
            g = {
              ...
              values: function(c, e) {
                return !!(
                  c.hasOwnProperty(e) &&
                  ((b = a.utils.toString(c[e]).toLowerCase()), "" !== d && b.search(d) > -1)
                )
              },
              reset: function() {
        ...
        b.exports = function(a) {
          a.sortFunction =
            ...
            function(b, c, d) {
              return (
                (d.desc = "desc" == d.order),
                a.utils.naturalSort(b.values()[d.valueName], c.values()[d.valueName], d)
              )
            }
          var b = {
              els: void 0,
            ...
            c = function() {
              ...
              d
                ...
                : ((c = arguments[1] || c),
                  ...
                  (c.order = c.order || "asc"),
                  (c.insensitive = "undefined" == typeof c.insensitive || c.insensitive)),
                b.clear(),
                b.setOrder(c),
          ...
          ;(this.clearSourceItem = function(b, c) {
            for (var d = 0, e = c.length; d < e; d++) {
              ...
              if (c[d].data)
                ...
                c[d].attr && c[d].name
                  ? ((f = a.utils.getByClass(b, c[d].name, !0)), f && f.setAttribute(c[d].attr, ""))
                  : ((f = a.utils.getByClass(b, c[d], !0)), f && (f.innerHTML = ""))
              f = void 0
            }
            return b
          }),
                ...
                if (d[f].data)
                  ...
                  d[f].attr && d[f].name
                    ? ((h = a.utils.getByClass(b.elm, d[f].name, !0)),
                      (e[d[f].name] = h ? a.utils.getAttribute(h, d[f].attr) : ""))
      ...
      function(a, b, c) {
        b.exports = function(a, b, c) {
          var d,
            ...
            t = function(a, b) {
              return (
                ((!a.match(k) || 1 == b) && parseFloat(a)) || a.replace(h, " ").replace(g, "") || 0
              )
            }
          if (s) {
            if (r < s) return -1

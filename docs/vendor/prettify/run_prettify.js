    ...
    function ba(g) {
      ...
      function z(k) {
        if ("readystatechange" != k.type || "complete" == A.readyState)
          ("load" == k.type ? t : A)[B](p + k.type, z, !1), !q && (q = !0) && g.call(t, k.type || k)
      }
      ...
      ;(function() {
        function k(a) {
          ...
          function b(e) {
            ...
            for (var a = a ? 1 : 0, h = b.length; a < h; ++a) {
              ...
              if (/\\[bdsw]/i.test(l)) c.push(l)
                ...
                65 > n ||
                  122 < l ||
                  (65 > n || 90 < l || e.push([Math.max(65, l) | 32, Math.min(n, 90) | 32]),
                  97 > n || 122 < l || e.push([Math.max(97, l) & -33, Math.min(n, 122) & -33]))
              }
            }
            e.sort(function(e, a) {
            ...
            for (a = 0; a < b.length; ++a)
              (l = b[a]),
                c.push(f(l[0])),
                l[1] > l[0] && (l[1] + 1 > l[0] && c.push("-"), c.push(f(l[1])))
            c.push("]")
            return c.join("")
          }
          function g(e) {
            ...
            for (l = h = 0; h < c; ++h)
              (n = a[h]),
                "(" === n
                  ? (++l, d[l] || (a[h] = "(?:"))
                  : "\\" === n.charAt(0) && (n = +n.substring(1)) && n <= l && (a[h] = "\\" + d[n])
          ...
          for (var k = 0, I = !1, m = !1, J = 0, c = a.length; J < c; ++J) {
            ...
            if (r.ignoreCase) m = !0
              ...
              /[a-z]/i.test(r.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi, ""))
            ) {
              I = !0
              m = !1
              break
          ...
          for (
            var W = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 }, u = [], J = 0, c = a.length;
            J < c;
            ++J
          ) {
            r = a[J]
        ...
        function p(a, d) {
          for (var f = d.length; 0 <= --f; ) {
            var b = d[f]
            X.hasOwnProperty(b)
              ? R.console && console.warn("cannot override language handler %s", b)
              : (X[b] = a)
          }
        }
        function F(a, d) {
        ...
        p(x({ keywords: N, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: Q }), [
          "cs"
        ])
        p(x({ keywords: M, cStyleComments: !0 }), ["java"])
        p(x({ keywords: K, hashComments: !0, multiLineStrings: !0 }), ["bash", "bsh", "csh", "sh"])
        p(x({ keywords: O, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }), [
          "cv",
          "py",
          "python"
        ])
        ...
        p(x({ keywords: P, hashComments: !0, multiLineStrings: !0, regexLiterals: !0 }), [
          "rb",
          "ruby"
        ])
        p(x({ keywords: L, cStyleComments: !0, regexLiterals: !0 }), ["javascript", "js"])
        p(
          x({
            keywords:
        ...
        var V = (R.PR = {
            ...
            prettyPrint: (g = g = function(a, d) {
              function f() {
                for (
                  var b = R.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity;
                  r < p.length && c.now() < b;
                  r++
                ) {
                    ...
                    if (!m) {
                        ...
                        var v = d.currentStyle,
                          ...
                          v =
                            (v = v
                              ...
                              ? y.getComputedStyle(d, null).getPropertyValue("white-space")
                      ...
                      ;(y = "true" === y || +y) ||
                        (y = (y = q.match(/\blinenums\b(?::(\d+))?/))
                          ...
                          : !1)
                      y && B(d, y, v)
                      H({ j: m, h: d, m: y, l: v, a: null, i: null, c: null, g: null })
                    }
                  }
                }

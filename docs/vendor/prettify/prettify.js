...
*/
  ...
  ;(function() {
    function T(a) {
      ...
      function b(e) {
        ...
        for (var a = a ? 1 : 0, g = b.length; a < g; ++a) {
          ...
          if (/\\[bdsw]/i.test(h)) c.push(h)
            ...
            65 > k ||
              122 < h ||
              (65 > k || 90 < h || e.push([Math.max(65, h) | 32, Math.min(k, 90) | 32]),
      ...
      for (
        var w = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 }, r = [], m = 0, c = a.length;
        m < c;
        ++m
      ) {
        p = a[m]
    ...
    t(y({ keywords: Q, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }), [
      "cv",
      "py",
      "python"
    ])
                    ...
                    var u = d.currentStyle,
                      ...
                      u =
                        (u = u
                          ...
                          ? x.getComputedStyle(d, null).getPropertyValue("white-space")

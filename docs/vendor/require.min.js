...
;(function(ha) {
  ...
  function Z(b, c, d, k) {
    c &&
      E(c, function(c, g) {
        if (d || !w(b, g))
          !k || "object" !== typeof c || !c || M(c) || L(c) || c instanceof RegExp
            ? (b[g] = c)
            : (b[g] || (b[g] = {}), Z(b[g], c, d, k))
      })
    return b
  ...
  function ma(b) {
    ...
    function p(a) {
      var n = g(m.paths, a)
      if (n && M(n) && 1 < n.length)
        return n.shift(), h.require.undef(a), h.makeRequire(null, { skipMap: !0 })([a]), !0
    }
    function e(a) {
      var n,
        b = a ? a.indexOf("!") : -1
        ...
        (z
          ? (A =
              d && d.normalize
                ...
                ? c(a, k, f)
                : a)
          : ((A = c(a, k, f)), (a = e(A)), (z = a[0]), (A = a[1]), (b = !0), (l = h.nameToUrl(A))))
      ...
      if (!ba) {
        ...
        E(aa, function(a) {
          ...
          if (a.enabled && (h.isDefine || l.push(a), !a.error))
            ...
            else if (!a.inited && a.fetched && h.isDefine && ((k = !0), !h.prefix)) return (g = !1)
        })
        if (c && f.length)
          return (
    ...
    var ba,
      ...
      S,
      ca,
      m = { waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} },
      t = {},
      aa = {},
      fa = {},
      H = [],
            ...
            if (1 > this.depCount && !this.defined) {
              if (L(l)) {
                ...
                if (a) {
                  ...
                  if ("undefined" !== typeof console && console.error) console.error(a)
                  else k.onError(a)
                }
              } else f = l
              this.exports = f
                ...
                : ((l = y(this, function(a) {
                  ...
                  (l.fromText = y(this, function(f, c) {
                    ...
                    try {
                      ...
                      return B(
                        G("fromtexteval", "fromText eval for " + b + " failed: " + g, g, [b])
                      )
                    }
                    N && (T = !0)
                    this.depMaps.push(e)
    ...
    h = {
      ...
      completeLoad: function(a) {
        ...
        if (!b && !w(r, a) && c && !c.inited)
          if (!m.enforceDefine || (e && ja(e))) J([a, d.deps || [], d.exportsFn])
          else return p(a) ? void 0 : B(G("nodefine", "No define call for " + a, null, [a]))
        I()
      },
      ...
      onScriptError: function(a) {
        ...
        if (!p(b.id)) {
          ...
          return B(
            G(
              "scripterror",
              'Script error for "' + b.id + (c.length ? '", needed by: ' + c.join(", ") : '"'),
              a,
              [b.id]
            )
          )
  ...
  if ("undefined" === typeof define) {
    ...
    k.load = function(b, c, d) {
      ...
      if (F) {
        ...
        !e.attachEvent ||
        (e.attachEvent.toString && 0 > e.attachEvent.toString().indexOf("[native code")) ||
        da
